...
class DeutscheTelekomFetcher(CompanyFetcher):
    """Deutsche Telekom 爬蟲"""

    company_id = "deutsche_telekom"
    company_name = "Deutsche Telekom"
    news_url = "https://www.deutschetelekom.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.deutschetelekom.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Deutsche Telekom")
        return documents
...
if __name__ == "__main__":
    fetcher = DeutscheTelekomFetcher()
