...
class CeragonFetcher(CompanyFetcher):
    """Ceragon Networks 爬蟲"""

    company_id = "ceragon"
    company_name = "Ceragon Networks"
    news_url = "https://www.ceragonnetworks.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ceragonnetworks.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ceragon Networks")
        return documents
