...
class CommscopeFetcher(CompanyFetcher):
    """CommScope Holding 爬蟲"""

    company_id = "commscope"
    company_name = "CommScope Holding"
    news_url = "https://www.commscopeholding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.commscopeholding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from CommScope Holding")
        return documents
