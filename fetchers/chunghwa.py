...
class ChunghwaFetcher(CompanyFetcher):
    """中華電信 爬蟲"""

    company_id = "chunghwa"
    company_name = "中華電信"
    news_url = "https://www.中華電信.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 中華電信")
        return documents
