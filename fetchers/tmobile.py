...
class TmobileFetcher(CompanyFetcher):
    """T-Mobile US 爬蟲"""

    company_id = "tmobile"
    company_name = "T-Mobile US"
    news_url = "https://www.t-mobileus.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.t-mobileus.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from T-Mobile US")
        return documents
