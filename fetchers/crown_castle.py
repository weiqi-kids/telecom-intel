...
class CrownCastleFetcher(CompanyFetcher):
    """Crown Castle 爬蟲"""

    company_id = "crown_castle"
    company_name = "Crown Castle"
    news_url = "https://www.crowncastle.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.crowncastle.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Crown Castle")
        return documents
