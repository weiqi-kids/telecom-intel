...
class FareastoneFetcher(CompanyFetcher):
    """遠傳電信 爬蟲"""

    company_id = "fareastone"
    company_name = "遠傳電信"
    news_url = "https://www.遠傳電信.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 遠傳電信")
        return documents
