...
class EquinixFetcher(CompanyFetcher):
    """Equinix 爬蟲"""

    company_id = "equinix"
    company_name = "Equinix"
    news_url = "https://www.equinix.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Equinix")
        return documents
