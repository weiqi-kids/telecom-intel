...
class CienaFetcher(CompanyFetcher):
    """Ciena Corporation 爬蟲"""

    company_id = "ciena"
    company_name = "Ciena Corporation"
    news_url = "https://www.cienacorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cienacorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ciena Corporation")
        return documents
