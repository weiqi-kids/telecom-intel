...
class VerizonFetcher(CompanyFetcher):
    """Verizon Communications 爬蟲"""

    company_id = "verizon"
    company_name = "Verizon Communications"
    news_url = "https://www.verizoncommunications.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.verizoncommunications.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Verizon Communications")
        return documents
