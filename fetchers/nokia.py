...
class NokiaFetcher(CompanyFetcher):
    """Nokia Corporation 爬蟲"""

    company_id = "nokia"
    company_name = "Nokia Corporation"
    news_url = "https://www.nokiacorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.nokiacorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Nokia Corporation")
        return documents
