...
class SoftbankFetcher(CompanyFetcher):
    """SoftBank Corp 爬蟲"""

    company_id = "softbank"
    company_name = "SoftBank Corp"
    news_url = "https://www.softbankcorp.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.softbankcorp.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from SoftBank Corp")
        return documents
