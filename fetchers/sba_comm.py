...
class SbaCommFetcher(CompanyFetcher):
    """SBA Communications 爬蟲"""

    company_id = "sba_comm"
    company_name = "SBA Communications"
    news_url = "https://www.sbacommunications.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sbacommunications.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from SBA Communications")
        return documents
