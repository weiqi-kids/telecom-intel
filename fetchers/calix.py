...
class CalixFetcher(CompanyFetcher):
    """Calix Inc 爬蟲"""

    company_id = "calix"
    company_name = "Calix Inc"
    news_url = "https://www.calixinc.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.calixinc.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Calix Inc")
        return documents
