...
class TaiwanMobileFetcher(CompanyFetcher):
    """台灣大哥大 爬蟲"""

    company_id = "taiwan_mobile"
    company_name = "台灣大哥大"
    news_url = "https://www.台灣大哥大.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 台灣大哥大")
        return documents
