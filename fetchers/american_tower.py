...
class AmericanTowerFetcher(CompanyFetcher):
    """American Tower 爬蟲"""

    company_id = "american_tower"
    company_name = "American Tower"
    news_url = "https://www.americantower.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.americantower.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from American Tower")
        return documents
